...
typedef struct _PyArray_Descr_fields {
         ...
         * object.
         */
        NPY_DECL_ALIGNED(16) PyTypeObject *typeobj;
        /* kind for this type */
        char kind;
...
typedef struct PyArrayIterObject_fields {
        ...
        PyObject_HEAD
#endif
        NPY_DECL_ALIGNED(16) int nd_m1;      /* number of dimensions - 1 */
        npy_intp          index, size;
...
typedef struct {
        ...
        PyObject_HEAD
#endif
        NPY_DECL_ALIGNED(16) int numiter;              /* number of iters */
