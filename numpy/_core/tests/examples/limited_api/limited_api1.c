 ...
 */
static PyObject *limited_api1_datetime_metadata(PyObject *mod, PyObject *arg)
{
...
static PyMethodDef limited_api1_methods[] = {
    {"datetime_metadata", (PyCFunction)limited_api1_datetime_metadata, METH_O,
...
static PyModuleDef moduledef = {
    ...
    .m_name = "limited_api1",
    .m_methods = limited_api1_methods
};
